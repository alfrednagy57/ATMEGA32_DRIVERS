...
#define TCCR1A_REG     (*(volatile Type_TCCR1A_REG__T1 * const)0x4F)

/*Timer/Counter1 Control Register B – TCCR1B*/
#define TCCR1B_REG     (*(volatile Type_TCCR1B_REG__T1 * const)0x4E)

// Timer Counter Interrupt Mask
#define TIMSK_REG      (*(volatile Type_TIMSK_REG__T1 * const)0x59)

//timer counter interrupt flag Register
#define TIFR_REG	   (*(volatile Type_TIFR_REG__T1 * const)0x58)
